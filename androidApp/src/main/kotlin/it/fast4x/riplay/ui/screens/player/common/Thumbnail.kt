...
import it.fast4x.riplay.services.playback.common.LoginRequiredException
import it.fast4x.riplay.services.playback.common.NoInternetException
import it.fast4x.riplay.services.playback.common.PlayableFormatNonSupported
import it.fast4x.riplay.services.playback.common.PlayableFormatNotFoundException
import it.fast4x.riplay.services.playback.common.TimeoutException
import it.fast4x.riplay.services.playback.common.UnknownException
import it.fast4x.riplay.services.playback.common.UnplayableException
import it.fast4x.riplay.services.playback.common.VideoIdMismatchException
...
fun Thumbnail(
    ...
    val player = binder?.hybridPlayer ?: return
