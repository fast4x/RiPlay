...
fun FolderItem(
    ...
    val iconColorFilter = remember(colorPalette.text) {
        ColorFilter.tint(colorPalette.text)
    }

    val iconSize = remember(thumbnailSizeDp) {
        thumbnailSizeDp - 15.dp
    }

    val noteOrPath = remember(folder.note, folder.fullPath) {
        folder.note ?: folder.fullPath
    }
