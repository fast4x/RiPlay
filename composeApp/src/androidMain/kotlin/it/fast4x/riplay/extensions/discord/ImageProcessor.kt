...
object ImageProcessor {
     ...
     * @throws java.io.IOException other read/write related issues
    ...
    fun compressArtwork(context: Context, artworkUri: Uri?, maxWidth: Int, maxHeight: Int, maxSize: Long ): Uri? {
        ...
        if ( mimeType == null || !mimeType.startsWith( "image/" ) )
            throw kotlin.IllegalArgumentException("The provided URI does not point to an image file. MIME type: $mimeType")
        ...
        try {
            ...
            if (decodedBitmap == null)
                throw kotlin.IllegalArgumentException("Failed to decode image into Bitmap from URI: $artworkUri")
